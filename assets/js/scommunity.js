...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const form = document.getElementById('addPostForm'); // <-- Fix: use correct ID
    if (form) { // Add null check to prevent errors if form is missing
    ...
    document.addEventListener('click', function (event) {
        ...
        if (button) {
            ...
            fetch('../../student/community/save_post.php', {
                method: 'POST',
                headers: {
    ...
    if (editPostModalForm) {
        editPostModalForm.addEventListener('submit', function (event) {
            ...
            // تنفيذ طلب AJAX
            fetch('../../student/community/edit_post.php', {
                method: 'POST',
                body: formData
            })
                .then(response => response.json())
    ...
    document.addEventListener('submit', function (event) {
        ...
        if (deletePostForm) {
            ...
            fetch('../../student/community/delete_post.php', {
                method: 'POST',
                body: formData,
            })
                .then((response) => response.json())
...
function loadPosts(filterType) {
    ...
    fetch('../../student/community/load_posts.php', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/x-www-form-urlencoded'
        },
