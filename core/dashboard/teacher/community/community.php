                ...
                <div class="row flex-column-reverse flex-sm-row g-3">
                    ...
                    <div class="col-md-3 shadow-sm rounded-3 bg-white h-100">
                        ...
                        <div class="accordion" id="accordionExample">
                            ...
                            <div class="accordion-item border-0">
                                <h2 class="accordion-header">
                                    <button class="accordion-button bg-white text-black shadow-none collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                        المعلمين
                                    </button>
                                </h2>
