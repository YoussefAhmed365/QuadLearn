                                    ...
                                    <div class="offcanvas offcanvas-end w-75 fs-5" tabindex="-1" id="offcanvasNavbar"
                                        ...
                                        <div class="offcanvas-body">
                                            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link" href="../files/subject_files.php">المحتوى
                                                        الدراسي</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link"
                                                        href="../notifications/notification.php">الإشعارات</a>
                                                </li>
                                                <li class="nav-item">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link active"
                                                        href="../community/community.php">المجتمع</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" href="../manage_usersshow-users.php">إدارة
                                                        الأعضاء</a>
                                                </li>
                                                <li class="nav-item">
                                                        ...
                                                        <a class="file-box row bg-transparent rounded-3 text-decoration-none mb-2"
                                                            ...
                                                            <div class="col-10">
                                                                <h6 class="mb-0 text-black text-truncate">
                                                                    <?php echo htmlspecialchars($originalName); ?></h6>
                            ...
                            <form id="addPostForm" method="POST" enctype="multipart/form-data">
                                <div class="row g-3 pb-5">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <button type="button" class="btn btn-light w-100 mt-1"
                                            onclick="addBadge('add')">إضافة شارة</button>
                                    </div>
                                    <div class="col-md-7">
                                        ...
                                        <?php $allowed_extensions = ['jpg', 'jpeg', 'png', 'webp', 'pdf', 'docx', 'doc', 'txt', 'pptx', 'xlsx', 'csv', 'zip', 'rar', 'mp4', 'avi', 'mov', 'mkv', 'webm']; ?>
                                        <small class="text-black">أقصى حجم للملف 5MB</small>
                                        <br>
                                        <small class="text-muted">الملفات المسموح بها:
                                            <?php echo implode(", ", $allowed_extensions); ?></small>
                                    </div>
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-default w-100">نشر</button>
                                        <div id="loadingSpinner"
                                            class="spinner-border spinner-border-sm text-defualt ms-2 d-none"
                                            role="status">
