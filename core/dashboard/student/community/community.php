        ...
        <main>
            <div class="container">
                <header class="manage mb-4">
                    <nav class="row">
                        <div class="col-sm-6 text">
                            ...
                            <nav class="navbar d-block d-sm-none">
                                <div class="container-fluid">
                                    ...
                                    <div class="offcanvas offcanvas-end w-75 fs-5" tabindex="-1" id="offcanvasNavbar"
                                        aria-labelledby="offcanvasNavbarLabel">
                                        <div class="offcanvas-header">
                                            <h5 class="offcanvas-title" id="offcanvasNavbarLabel"><img
                                                    src="../../../../assets/images/logo.svg" alt="QuadLearn"
                                                    class="me-3" style="width: 40px;">QuadLearn</h5>
                                        ...
                                        <div class="offcanvas-body">
                                            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                                                <li class="nav-item">
                                                    <a class="nav-link" aria-current="page"
                                                        href="../main/dashboard.php">الرئيسية</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link"
                                                        href="../notifications/notifications.php">الإشعارات</a>
                                                </li>
                                                <li class="nav-item">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link"
                                                        href="../instructors/show-teachers.php">المعلمين</a>
                                                </li>
                                                <li class="nav-item">
                                            ...
                                            <form method="POST" action="../../../logout.php"
                                                ...
                                                <button type="submit" name="logout"
                                                    style="display: flex;flex-direction: column;align-items: center;">
                                                    <i class="fa-solid fa-arrow-right-from-bracket fs-1"
                                                        aria-hidden="true"></i>
                                                </button>
                                            </form>
                                        </div>
                        ...
                        <div class="col-sm-6 justify-content-end profile">
                            <div class="notification d-flex flex-column justify-content-center align-items-end">
                                <div class="icon position-relative">
                                    ...
                                    <div class="panel shadow-sm rounded-top-4 position-absolute z-2">
                                        ...
                                        <hr>
                                        <div
                                            class="body overflow-y-scroll bg-white d-flex flex-column justify-content-start align-items-center p-3">
                                            <!-- ظهور المحتوى هنا -->
                                        </div>
                                    </div>
                                </div>
                            ...
                            <a href="../settings/settings.php"
                                class="profile-badge d-flex bg-white rounded-4 shadow-sm p-2 text-decoration-none align-items-center gap-3 position-relative">
                                <span
                ...
                <div class="row flex-column-reverse flex-sm-row g-3">
                    <div class="col-md-9">
                        <div
                            class="add-post rounded-3 bg-white shadow-sm p-3 mb-4 d-flex justify-content-between align-items-center">
                            <h5 class="text-secondary m-0">إضافة منشور جديد</h5>
                            <button type="button" class="btn btn-default" data-bs-toggle="modal"
                                data-bs-target="#addPostModal"><i class="fa-solid fa-plus"></i></button>
                        </div>
                        <div class="input-group flex-nowrap mb-4 shadow-sm">
                            <span class="input-group-text" id="addon-wrapping"><i class="fa-solid fa-magnifying-glass"
                                    aria-hidden="true"></i></span>
                            <input type="search" id="searchInput" class="form-control" placeholder="بحث"
                        ...
                        <div class="accordion" id="accordionExample">
                            <div class="accordion-item border-0">
                                <h2 class="accordion-header">
                                    <button class="accordion-button bg-white text-black shadow-none" type="button"
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body rounded-4 bg-light">
                                        <div
                                            class="subjects d-flex flex-column justify-content-center align-items-start px-2 gap-3">
                                            <?php
                                            ...
                                            if ($result->num_rows > 0) {
                                                ...
                                                foreach ($teachers as $teacher_id => $teacher) {
                                                    ...
                                                    ?>
                                                    <button class="row btn btn-light d-flex align-items-center subjectBtn"
                                                        ...
                                                        <div
                                                            class="col-4 overflow-hidden rounded d-flex justify-content-center align-items-center">
                                                            <img src="../../../../assets/images/<?php echo htmlspecialchars($subject); ?>.webp"
                                                                alt="subject">
                                                        </div>
                                                ...
                                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="subjectModalLabel">منشورات
                                                                المادة</h5>
                                            ...
                                            <!-- Add Teacher -->
                                            <a href="../instructors/show-teachers.php"
                                                class="add-teacher row d-flex align-items-center btn btn-default rounded-4 shadow mt-4">
                                                <div
                                                    class="col-3 rounded-4 bg-light d-flex justify-content-center align-items-center h-75">
                                                    <i class="fa-solid fa-user-plus text-secondary fs-5"
                                                        aria-hidden="true"></i>
                                                </div>
                                                <div class="col-9">
                            ...
                            <div class="accordion-item border-0">
                                <h2 class="accordion-header">
                                    <button class="accordion-button bg-white text-black shadow-none collapsed"
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                if (!empty($uploadedFiles) && is_array($uploadedFiles)) {
                                                    ...
                                                    foreach ($uploadedFiles as $index => $fileName) {
                                                        ...
                                                        ?>
                                                        <a class="file-box row bg-transparent rounded-3 text-decoration-none mb-2"
                                                            href='<?php echo $fileURL; ?>' download>
            ...
            <div class="modal fade" id="addPostModal" tabindex="-1" aria-labelledby="addPostModal" aria-hidden="true">
                <div
                    class="modal-dialog modal-lg modal-fullscreen-md-down modal-dialog-centered modal-dialog-scrollable">
                    <div class="modal-content">
                        ...
                        <div class="modal-body px-5 pt-2">
                            <form id="addPostForm" method="POST" enctype="multipart/form-data">
                                <div class="row g-3 pb-5">
                                    <div class="col-12">
                                        <label for="subject" class="form-label">المادة الدراسية<small
                                            ...
                                            if ($result->num_rows > 0) {
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <option value="<?php echo $subject; ?>">
                                                        <?php echo htmlspecialchars($translated_subject); ?>
                                                    </option>
                                                    <?php
                                                }
                                            }
                                    ...
                                    <div class="col-12">
                                        <label for="postContent" class="form-label">المحتوى<small
                                                class="text-danger">*</small></label>
                                        <textarea id="postContent" class="form-control" name="content" rows="4"
                                            required></textarea>
                                    </div>
                                    <div class="col-5">
                                        <p>الشارات</p>
                                        <div id="badges-container"></div>
                                        <button type="button" class="btn btn-light w-100" onclick="addBadge()">إضافة
                                            شارة</button>
                                    </div>
                                    <div class="col-7">
                                        <label for="uploaded_files" class="form-label">رفع الملفات</label>
                                        <input type="file" id="uploaded_files" class="form-control"
                                            name="uploaded_files[]" multiple>
                                        <small class="text-muted">الملفات المسموح بها: JPEG, PNG, PDF. الحد
                                            الأقصى للحجم: 5 ميغابايت</small>
                                    </div>
                                    <div class="col-12">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="d-flex flex-column justify-content-center align-items-center" id="messageDiv">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- Edit Post Modal -->
             <div class="modal fade" id="editPostModal" tabindex="-1" aria-labelledby="editPostModalLabel"
                ...
                <div
                    ...
                    <div class="modal-content">
                        <div class="modal-header border-0">
                            <h5 class="modal-title fs-5" id="editPostModalLabel">تعديل المنشور</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body px-5 pt-2">
                            <form id="editPostForm" method="POST" enctype="multipart/form-data">
                                <div class="row g-3 pb-5">
                                    ...
                                    <div class="col-12">
                                        <label for="editPostContent" class="form-label">المحتوى<small
                                                class="text-danger">*</small></label>
                                    ...
                                    <div class="col-md-5">
                                        <h6>الشارات</h6>
                                        <div id="editBadgesContainer">
                                            <!-- Badges will be populated by JavaScript -->
                                        </div>
                                        <button type="button" class="btn btn-sm btn-outline-secondary mt-2 w-100"
                                            onclick="addBadge('edit')">إضافة شارة</button>
                                    </div>
                                    <div class="col-md-7">
                                        <h6>الملفات الحالية</h6>
                                        <div id="editExistingFiles" class="mb-2"
                                            style="max-height: 150px; overflow-y: auto; border: 1px solid #dee2e6; padding: 0.375rem 0.75rem; border-radius: 0.25rem;">
                                            <!-- Existing files will be populated by JavaScript -->
                                            <p class="text-muted small">لا توجد ملفات مرفقة حالياً.</p>
                                        </div>
                                        <label for="editNewUploadedFiles" class="form-label">إضافة ملفات جديدة:</label>
                                        <input type="file" id="editNewUploadedFiles"
                                            class="form-control form-control-sm" name="new_uploaded_files[]" multiple>
                                        <?php
                                        // Assuming $allowed_extensions is defined in the scope of community.php
                                        // If not, you might need to redefine it or ensure it's available.
                                        $allowed_extensions_for_edit_modal = ['jpg', 'jpeg', 'png', 'webp', 'pdf', 'docx', 'doc', 'txt', 'pptx', 'xlsx', 'csv', 'zip', 'rar', 'mp4', 'avi', 'mov', 'mkv', 'webm'];
                                        ?>
                                        <small class="form-text text-black d-block mt-1">أقصى حجم للملف 5MB.</small>
                                        <small class="form-text text-muted">الملفات المسموح بها:
                                            <?php echo implode(", ", $allowed_extensions_for_edit_modal); ?></small>
                                    </div>
                                    <div class="col-12 mt-4">
                                        <button type="submit" class="btn btn-default w-100">حفظ التغييرات</button>
                                        <div id="editPostLoadingSpinner"
