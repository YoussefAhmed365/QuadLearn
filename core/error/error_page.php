...
<head>
    ...
    <title>حدثت مشكلة ما | QuadLearn</title>
    <style>
        :root{
            --primary: #2c6975;
            --secondary: #68b2a0;
        ...
        .btn-default:focus{
            box-shadow:  0 0 0 0.25rem rgba(41, 92, 82, 0.5); 
        }
        .btn-default:active{
            color: #fff;
            background: #295c52;
...
<body>
    <div class="bg-warning w-100 text-center p-2 fs-6">نـسـخـة تـجـريـبـيـة قـيـد الـتـطـويـر</div>
    <div class="container">
        <div class="error-container">
            <div class="error-code">
                <i class="fas fa-exclamation-triangle"></i> 
            </div>
            <h1 class="display-4">عفواً، حدث خطأ!</h1>
            <p class="lead">
                <?php 
                if(isset($_GET['error'])){
            ...
            <a href="javascript:history.back()" class="btn btn-default">الرجوع إلى الصفحة السابقة</a>
        </div>
    </div>
